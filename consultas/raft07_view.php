  ...
  <table class="tabla" border="1px">
        <thead>
          <tr>
            ...
            <th>NUIP</th>
            <th>MOTIVO DE DESTRUCCIÓN</th>
            <th>FORMATO A DESTRUIR</th>
          ...
          <tbody>
            ...
            while($contacto= $respuesta->fetch_assoc()){
              ...
              ?>
                ...
                <td><?php echo $contacto['m_destruccion']; ?></td>
                <td><?php echo $contacto['formato_destruir']; ?></td>
                <td><?php echo $contacto['oficina_preparacion']; ?></td>
                <td><?php echo $contacto['codigo_oficina']; ?></td>
                <td><?php echo $contacto['no_acta_destruccion']; ?></td>
                <td><?php echo $contacto['fecha_destruccion']; ?></td>
            ...
            ?>
				...
				<a href="raft07.php"><button type="submit" class="buttonSubmit" name="button">Registrar Datos</button></a>
				</center>
