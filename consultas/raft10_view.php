...
<center>
  <table class="tabla" border="1px">
        <thead>
          ...
          <tbody>
            ...
            while($contacto= $respuesta->fetch_assoc()){
              ...
              ?>
                <td><?php echo $contacto['semana_fecha_inicial']; ?></td>
                <td><?php echo $contacto['item']; ?></td>
                <td><?php echo $contacto['sts']; ?></td>
                <td><?php echo $contacto['ts']; ?></td>
                <td><?php echo $contacto['p.v_cc']; ?></td>
                <td><?php echo $contacto['renov_cc']; ?></td>
                <td><?php echo $contacto['rect_cc']; ?></td>
                <td><?php echo $contacto['dupli_cc']; ?></td>
                <td><?php echo $contacto['pv_ti']; ?></td>
                <td><?php echo $contacto['dupli_ti']; ?></td>
        ...
        <a href="raft10.php"><button type="submit" class="buttonSubmit" name="button">Registrar Datos</button></a>
</center>
